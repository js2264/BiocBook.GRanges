...
- Learn how to make basic EDA plots (plotting scaled counts)
...
Start by loading this RNA-seq dataset from the following paper by
@king_klose: ["The pioneer factor OCT4 requires the chromatin remodeller BRG1 to support gene regulatory element function in mouse embryonic stem cells"](https://doi.org/10.7554/eLife.22631). The
