...
- determine if one set of peaks are overlapping another set
...
The motivation for sampling blocks, instead of placing features
...
the genome, even after considering things like excluded regions. 
...
The approach used in *nullranges* to generate
